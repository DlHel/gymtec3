...
import { getChecklistsForModel } from "@/app/dashboard/knowledge-base/actions"
import { updateTicketChecklistState } from "@/app/dashboard/tickets/actions"
...
export function TicketChecklist({ modelName, ticketId, initialChecklistStateJSON }: TicketChecklistProps) {
    ...
    useEffect(() => {
        getChecklistsForModel(modelName).then(data => {
            setChecklists(data);
            setIsLoading(false);
        });
